...
function buildClaudeMarketplace(version) {
  return {
    ...
    description: 'Aimin 本地命令 marketplace，提供 /am:init、/am:api、/am:plan、/am:update、/am:session',
    owner: {
      name: 'Aimin',
...
function buildCodexPluginManifest(version) {
  return {
    ...
    interface: {
      ...
      longDescription: '提供 Aimin 项目规范参考，并配合 $am、$am-init、$am-api、$am-plan、$am-update、$am-session 使用。',
      developerName: 'Aimin',
      category: 'Productivity',
