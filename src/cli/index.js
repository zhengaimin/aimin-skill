...
async function runInitCommand(options) {
  ...
  for (const item of result.results) {
    ...
    if (item.tool.key === 'claude')
      writeLine(options.stdout, '  commands: /am:init, /am:api, /am:plan, /am:review, /am:update, /am:session');
    else
      writeLine(options.stdout, '  skills: $am, $am-init, $am-api, $am-plan, $am-review, $am-update, $am-session');
  }
